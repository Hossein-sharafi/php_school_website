<script type="text/javascript">
    window.$crisp = [];
    window.CRISP_WEBSITE_ID = "6b27c243-2b81-4581-8cf5-17e00a3b976d";
    (function() {
        d = document;
...
<body class="bodySetting body" dir="rtl">
    ...
    <div>
        ...
        <!--start body-->
        <div>
            <div style="margin-right: 3%; margin-top: 5%">
                <h1>رئیس انجمن:</h1>
                <h2>رهام صفدری</h2>
            </div>
            <div style="margin-right: 3%; margin-top: 5%">
                <h1>اهدف انجمن تاریخ</h1>
                <h3 style="margin-right: 1%;">1- تقویت اطلاعات دانش آموزان مدرسه</h3>
                <h3 style="margin-right: 1%;">2- استفاده بهینه از زنگ های تفریح</h3>
                <h3 style="margin-right: 1%;">3- بالا بردن سطح مطالعه کتاب های کتابخانه</h3>
            </div>
            <div style="margin-right: 3%; margin-top: 5%">
                <h2>روز های برگزاری</h2>
                <h3 style="margin-right: 1%;">انجمن تاریخ در روز های سه شنبه زنگ تفریح اخر در آزمایشگاه فیزیک برگزار میگیردد</h3>
            </div>
            <div style="margin-right: 3%; margin-top: 5%; margin-bottom:10%">
                <h2>راه های ارتباطی انجمن تاریخ</h2>
                <h3>1- استفاده از بخش پشتیبانی پایین سمت راست صفحه</h3>
                <h3>2- مراجعه به رئیس انجمن تاریه به صورت حضوری</h3>
            </div>
